...
// import mindustry.type.StatusEffect;as
...
public class SuperPowers_testing {
...
private static void spawnDisruptUnit(Player player, World world, float playerX, float playerY) {
    ...
    if (playerData.getPoints() >= price) {
        ...
        //     UnitTypes.reign
        // };
        UnitType unittoSpawn=UnitTypes.collaris;
        Weapon[] weaponsToAdd = {
            UnitTypes.corvus.weapons.get(0),
            UnitTypes.corvus.weapons.get(0),
            UnitTypes.corvus.weapons.get(0),
            // UnitTypes.collaris.weapons.get(0),
            // UnitTypes.collaris.weapons.get(1),
        ...
        {
            Unit unit = unittoSpawn.spawn(playerX, playerY);
            if (unit != null && unit.isValid()) {
                unit.type.weapons.clear();
                ...
                unit.type.rotateMoveFirst = true;
